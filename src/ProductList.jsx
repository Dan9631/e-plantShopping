...
function ProductList({ onHomeClick }) {
    ...
    const totalCart = cart.reduce((acumulator, item) => acumulator + item.quantity,0);
    const plantsArray = [
        {
                ...
                <div className="product-grid">
                    ...
                    <div key={index}>
                        ...
                        {category.plants.map((plant, plantIndex) => (
                            ...
                            <button
                                className={
                                    `product-button ${validateToAdded(plant.name) ? 'added-to-cart' : ''}`}
                                disabled={validateToAdded(plant.name)}
                                onClick={() => handleAddToCart(plant)}
                            >
                                {validateToAdded(plant.name)? "Added to Cart":"Add to Cart"}
                            </button>
                            </div>
                        ))}
                        </div>
